...
/**
 * A dynamic size Queue using a circular linked chain of Nodes.
 *
 * This Queue contains only one external reference to the chain; lastNode
 * lastNode contains a reference to the first Node. If lastNode.getNext = null,
 * the bag is empty. If lastNode.getNext = lastNode,the bag is size 1.
 *
 * @author Erik Lunna
 */
