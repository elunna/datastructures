...
/**
 * Test driver for the datastructures package
 *
 * @author Erik Lunna
 */
...
//        MatrixInterface matrixSum = matrix1.sum((Matrix) matrix2);
//        System.out.println("Displaying the sum:");
//        analyzeMatrix(matrixSum);
        System.out.println("Multiplying matrices");
        MatrixInterface matrixProduct = matrix1.product((Matrix) matrix2);
